...
通常、 view コンポーザは、アプリケーションの[service providers](/ja/php/laravel/v11.x/03-architecture-concepts)のいずれかに登録されます。この例では、`App\Providers\AppServiceProvider`がこのロジックを保管すると仮定します。
