...
[公式 Node ウェブサイト](https://nodejs.org/en/download/)から簡単なグラフィカルインストーラを使用して、Node と NPM の最新バージョンを簡単にインストールできます。または、[Laravel Sail](https://laravel.com/docs/11.x/sail)を使用している場合は、 Sail を通じて Node と NPM を呼び出すことができます。
...
もしあなたが[Laravel Herd](https://herd.laravel.com)を利用してサイトをセキュアに運用している場合、または[Laravel Valet](/ja/php/laravel/v11.x/10-packages/valet)を使用し、自身の application に対して[secure command](/docs/11.x/valet#securing-sites)を実行している場合、 Laravel Vite プラグインは、自動的に生成された TLS 証明書を検出し使用します。
...
> [!NOTE]  
> Laravel の[スターターキット](/ja/php/laravel/v11.x/02-getting-started/05-starter-kits)には、適切な Laravel、Vue、および Vite の設定がすでに含まれています。Laravel、Vue、および Vite を最速で始める方法として、[Laravel Breeze](/docs/11.x/starter-kits#breeze-and-inertia)をご覧ください。
...
> [!NOTE]  
> Laravel の[スターターキット](/ja/php/laravel/v11.x/02-getting-started/05-starter-kits)には、すでに適切な Laravel、React、Vite の設定が含まれています。Laravel、React、Vite を最も速く始めるための最適な方法は、 [Laravel Breeze](/docs/11.x/starter-kits#breeze-and-inertia)をご覧ください。
...
> [!NOTE]  
> Laravel の[スターターキット](/ja/php/laravel/v11.x/02-getting-started/05-starter-kits)には既に適切な Laravel、Inertia、そして Vite の設定が含まれています。 Laravel、Inertia、そして Vite を最も迅速に始める方法については、[Laravel Breeze](/docs/11.x/starter-kits#breeze-and-inertia)をご覧ください。
...
””JavaScript””アプリケーションでは、よく参照されるディレクトリに [””aliases””を作成](#aliases) することが一般的です。しかし、`Illuminate\Support\Facades\Vite` ””class””の`macro` ””method””を使用して、””Blade””で使用する””aliases””を作成することもできます。通常、"macros" は [””service provider””](/ja/php/laravel/v11.x/03-architecture-concepts) の`boot` ””method””内で定義する必要があります。
...
> [!NOTE]  
> Laravel の[スターターキット](/ja/php/laravel/v11.x/02-getting-started/05-starter-kits)には、適切な Laravel、Inertia SSR、および Vite の設定がすでに含まれています。Laravel、Inertia SSR、および Vite で最も迅速に始める方法については、[Laravel Breeze](/docs/11.x/starter-kits#breeze-and-inertia)をご覧ください。
