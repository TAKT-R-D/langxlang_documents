...
> [!NOTE]  
> [マスアサインメント保護](/ja/php/laravel/v11.x/08-eloquent-orm/01-eloquent#mass-assignment)は、 database seeding 中に自動的に無効になります。
...
> [!NOTE]  
> `run`メソッドの signature 内で必要な依存関係をタイプヒントとして指定することができます。それらは自動的に Laravel の[service container](/ja/php/laravel/v11.x/03-architecture-concepts/02-container)を介して解決されます。
