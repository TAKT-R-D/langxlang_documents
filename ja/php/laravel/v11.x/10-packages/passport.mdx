...
あなたの application の””users””は`client`の””command””を利用できないため、Passport は client を作成するための””JSON API””を提供しています。これにより、client の作成、更新、そして””削除””のためのコントローラを手動で””code””する手間が省けます。
