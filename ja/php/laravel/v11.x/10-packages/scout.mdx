...
レコードを””削除””する前に””model””を取得したくない場合は、`unsearchable` ””method””を””Eloquent query””インスタンスで使用することができます：
...
””models””の””collection””を取得するだけでなく、`paginate` ””method””を使用して””検索””結果を””ページネート””することができます。この””method””は、[伝統的な””Eloquent query””をページネートした](/ja/php/laravel/v11.x/07-database/03-pagination)かのように、`Illuminate\Pagination\LengthAwarePaginator`インスタンスを返します。
