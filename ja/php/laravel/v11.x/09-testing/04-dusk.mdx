...
> [!NOTE]
> あなたがローカル開発の environment を管理するために[Laravel Sail](/ja/php/laravel/v11.x/10-packages/sail)を使用している場合は、[Dusk テストの設定と実行](/ja/php/laravel/v11.x/10-packages/sail#laravel-dusk)についての Sail のドキュメンテーションも参照してください。
...
> [!NOTE] > [Laravel Sail](/ja/php/laravel/v11.x/10-packages/sail)を使用してローカル開発の environment を管理している場合は、[Dusk テストの設定と実行](/ja/php/laravel/v11.x/10-packages/sail#laravel-dusk)についての Sail のドキュメンテーションをご覧ください。
