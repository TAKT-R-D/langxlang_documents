...
Laravel 11 はより少ない default application ファイルを持つ新しい”applications の default 構造”を導入します。つまり、新しい Laravel applications には、より少ない service providers 、 middleware 、および設定ファイルが含まれています。
