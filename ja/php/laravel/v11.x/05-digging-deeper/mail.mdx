...
> [!NOTE]  
> これらの問題を回避する方法について詳しく知るために、[キュー内の jobs と database transaction](/ja/php/laravel/v11.x/05-digging-deeper/queues#jobs-and-database-transactions)に関するドキュメンテーションをご覧ください。
