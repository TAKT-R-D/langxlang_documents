...
> <LaravelNote type="note" />
> Markdown のメールを書くときに過度なインデントを使わないでください。 Markdown の標準によれば、
> Markdown パーサーはインデントされた content を code ブロックとして render します。
...
> transaction](/ja/php/laravel/v11.x/05-digging-deeper/queues#jobs-and-database-transactions)に関するドキュメンテーションをご覧ください。
