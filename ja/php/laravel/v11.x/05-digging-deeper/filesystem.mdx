...
次に、application の[service providers](/ja/php/laravel/v11.x/03-architecture-concepts)のうちの 1 つの `boot` method で driver を register できます。これを達成するには、`Storage` facade の `extend` method を使用するべきです。
