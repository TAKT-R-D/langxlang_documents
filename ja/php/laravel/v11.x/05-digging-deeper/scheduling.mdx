...
Laravel はスケジューリングの process 中に様々な[events](/ja/php/laravel/v11.x/05-digging-deeper/events)を dispatches します。以下の events のいずれかに対して[listeners を定義](/docs/11.x/events)することができます：
