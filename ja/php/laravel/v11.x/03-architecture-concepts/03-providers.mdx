...
> [!NOTE]  
> もし、 Laravel がリクエストをどのように処理し、内部でどのように動作するかについて詳しく学びたい場合は、 Laravel の [request ライフサイクル](/ja/php/laravel/v11.x/03-architecture-concepts/01-lifecycle)に関するドキュメンテーションをご覧ください。
