...
> - [Route Groups](/ja/javascript/next.js/v14/02-app/01-building-your-application/01-routing/07-route-groups)を使用して複数の rootLayout を作成することができます。[ここ](/ja/javascript/next.js/v14/02-app/01-building-your-application/01-routing/route-groups#creating-multiple-root-layouts)で例をご覧ください。
